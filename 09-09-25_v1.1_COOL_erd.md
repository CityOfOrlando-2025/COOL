...
erDiagram
    ...
    device {
        ...
        INT status_id FK "Points to device_status"
        
        INT location_id FK "Points to location"
        INT created_by_user_id FK "Points to app_user"
        TIMESTAMP created_at
        TIMESTAMP updated_at
    }
    ...
    loan {
        ...
        INT device_id FK "Points to device"
